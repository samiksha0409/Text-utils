        ...
        <>
            ...
            <div className="accordion my-4" id="accordionExample">
                <div className="accordion-item">
                    <h2 className="accordion-header" style={{backgroundColor:props.mode === 'light'?'whitesmoke':'black'}}>
                    ...
                    <div className="accordion-body" style={{backgroundColor:props.mode === 'light'?'whitesmoke':'#333',color:props.mode === 'light'?'black':'white'}}>
